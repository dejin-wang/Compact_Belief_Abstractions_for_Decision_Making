...
if __name__ == '__main__':
    ...
    policy_net.load_state_dict(torch.load('dqn_model_m_medium.pth', map_location=device))
    ...
    for i_episode in range(num_episodes):
        ...
        if i_episode % 10 == 0:
            torch.save(policy_net.state_dict(), 'dqn_model_m_medium.pth')
