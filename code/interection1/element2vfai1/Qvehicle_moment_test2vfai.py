...
if __name__ == '__main__':
    ...
    policy_net.load_state_dict(torch.load('dqn_model_m2vfai1.pth', map_location=device))
    ...
    for i_episode in range(num_episodes):
        ...
        for t in count():
            ...
            done = (state.numpy()[0][0] < 0) or (t > 100)
    ...
    with open('DQN_M_reward_test2vfai1_4.csv', 'w', newline='') as csvfile:
