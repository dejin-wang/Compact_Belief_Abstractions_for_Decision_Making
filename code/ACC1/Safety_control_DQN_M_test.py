...
if __name__ == '__main__':
    ...
    policy_net.load_state_dict(torch.load('dqn_model_m.pth', map_location=device))
    ...
    for i_episode in range(num_episodes):
        ...
        particles, weights = particle_filter(num_particles, measurement, particles, weights, action_index_before)
        ...
        for t in range(20):
            ...
            particles, weights = particle_filter(num_particles, measurement, particles, weights, action_index)
            mean, cov, skew = compute_moments(particles, weights)
...
print(reward_set[0])
import csv
with open('DQN_M_reward_test.csv', 'w', newline='') as csvfile:
